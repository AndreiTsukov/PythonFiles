...
volume_sphere(int(input('enetr radius>> ')))
'''
#==================================================================
...
def sum_two_numbers(a, b):
    result = a + b
    return result
z = sum_two_numbers(9,7)
print(z)
'''
#==================================================================
#Documented function that returns the volume of a cylinder
'''
...
x2 = float(input('x2 = '))
y2 = float(input('y2 = '))
result = ras4et(x1,y1,x2,y2)
print('Ваше значение = ',result)
'''
#==================================================================
'''
def a(my_data):
